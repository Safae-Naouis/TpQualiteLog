...
public interface IBanqueDao {
	...
	// les 'effectuer' --> dans la couche metier --> donc � �liminer de cette couche
	...
	// public void virement(String codeCompteRetrait,String
	// codeCompteVersement,double montant, Long codeEmploye);
